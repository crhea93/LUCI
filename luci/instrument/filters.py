...
class UnsupportedFilterError(ValueError):
    ...
    def __init__(self, filter_name: object) -> None:
        ...
        super().__init__(f"Filter {filter_name!r} is not supported by LUCI. Supported filters: {supported}.")
...
class PCABackgroundUnsupportedError(ValueError):
    ...
    def __init__(self, filter_name: object) -> None:
        ...
        super().__init__(
            f"PCA background subtraction is not implemented for filter {filter_name!r}. Supported: {supported}."
        )
        self.filter_name = filter_name
